...
//WebUI.callTestCase(findTestCase('TC-Login'), [('username') : GlobalVariable.login_username, ('password') : GlobalVariable.login_password], FailureHandling.STOP_ON_FAILURE)
            ...
            for (def iii = 1; iii <= jumlahProduk; iii++) {
                ...
                if (WebUI.verifyElementPresent(productObjects, 1, FailureHandling.OPTIONAL)) {
                    ...
                    if (WebUI.verifyElementText(productObjects, productData, FailureHandling.OPTIONAL)) {
                        ...
                        WebUI.waitForElementPresent(findTestObject('Object Repository/page_detail_product/txt_productName'), 
                            10)

                        WebUI.delay(3)

                        namaProduk = WebUI.getText(findTestObject('Object Repository/page_detail_product/txt_productName'))
                        ...
                        if (namaProduk == productData) {
                            ...
                            WebUI.click(findTestObject('Object Repository/page_detail_product/btn_addToCart'))
...
for (def jumlahItem = 1; jumlahItem <= nData; jumlahItem++) {
    TestObject cartProductObjects = new TestObject().addProperty('xpath', ConditionType.EQUALS, ('//*[@id="tbodyid"]/tr[' + 
        jumlahItem) + ']/td[2]')
